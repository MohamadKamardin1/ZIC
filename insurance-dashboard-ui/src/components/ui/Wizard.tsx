...
export function Wizard({ steps, initialStep = 0, onCancel, onComplete, onAutosave, className = "" }: { steps: WizardStep[]; initialStep?: number; onCancel?: () => void; onComplete?: () => void; onAutosave?: (step: WizardStep, index: number) => void | Promise<void>; className?: string }) {

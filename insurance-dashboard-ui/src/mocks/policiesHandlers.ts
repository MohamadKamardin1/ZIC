...
const ids = {
  ...
  matured: "policy-matured-1",
  matured2: "policy-matured-2",
  maturedZero: "policy-matured-zero",
...
const basePolicies = [
  ...
  {
    id: ids.matured,
    policy_number: "ZIC-OL-2025-000101",
    proposal_ref_display: "OLP-2025-000101 — Juma Hassan",
    policyholder_display: "P-000021 — Juma Hassan",
    policyholder_name: "Juma Hassan",
    product_plan_display: "OL_ENDOWMENT — OL Endowment Savers",
    product_name: "OL Endowment Savers",
    plan_name: "Endowment savings",
    agent_display: "AG-0004 — Faraja Intermediaries",
    agent_name: "Faraja Intermediaries",
    currency: "TZS",
    sum_assured: "60000000.00",
    maturity_value: "60000000.00",
    premium_amount: "200000.00",
    premium_frequency: "MONTHLY",
    term_years: 20,
    risk_commencement_date: "2025-01-15",
    maturity_date: "2026-08-15",
    status: "MATURED",
    status_display: "Matured",
    allowed_actions: ["view", "print", "claim", "maturity"],
    version: 2,
  ...
  {
    id: ids.matured2,
    policy_number: "ZIC-OL-2025-000102",
    proposal_ref_display: "OLP-2025-000102 — Neema Petro",
    policyholder_display: "P-000022 — Neema Petro",
    policyholder_name: "Neema Petro",
    product_plan_display: "OL_EDU_GROWTH — Elimu Bora Growth Plan",
    product_name: "Elimu Bora Growth Plan",
    plan_name: "Education savings",
    agent_display: "AG-0007 — Zanzibar Life Brokers",
    ...
    currency: "TZS",
    sum_assured: "15000000.00",
    maturity_value: "15000000.00",
    premium_amount: "90000.00",
    premium_frequency: "MONTHLY",
    term_years: 12,
    risk_commencement_date: "2025-02-01",
  ...
  {
    id: ids.maturedZero,
    policy_number: "ZIC-OL-2025-000103",
    proposal_ref_display: "OLP-2025-000103 — Salim Abdallah",
    policyholder_display: "P-000023 — Salim Abdallah",
    policyholder_name: "Salim Abdallah",
    product_plan_display: "OL_TERM_STANDARD — ZIC Term Assurance Standard",
    product_name: "ZIC Term Assurance Standard",
    plan_name: "Standard protection",
    agent_display: "AG-0004 — Faraja Intermediaries",
    ...
    premium_frequency: "MONTHLY",
    term_years: 10,
    risk_commencement_date: "2025-03-01",

...
import { glSchemes } from "../../lib/gl-api"
...
export default function GLSchemes() {
  ...
  const loadSchemes = useCallback(async () => {
    ...
    try {
      ...
      const res = await glSchemes.list(params)
  ...
  useEffect(() => {
    glSchemes.dashboardSummary().then(setSummary).catch(() => {})
  }, [])

  async function viewDetail(id: string) {
    setDetailLoading(true)
    try {
      const detail = await glSchemes.get(id)
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted-foreground mt-1">Group Life policy management</p>
      </div>

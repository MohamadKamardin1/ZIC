...
import { DateInput, DecimalInput, FormGrid, TextInput, TextareaInput, Toggle } from "../../components/ui"
...
const screens: Record<ScreenKey, { key: ScreenKey; title: string; description: string; endpoint: string; effectiveDated: boolean; columns: TableColumn<ProductRecord>[]; filters: FilterDefinition[] }> = {
  ...
  products: {
    ...
    columns: commonColumns([
      { key: "plan_type", label: "Plan type", field: "plan_type", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) },
    ...
    ]), filters: [{ key: "plan_type", label: "Plan type", type: "text", placeholder: "Search plan types" }, { key: "insurance_class", label: "Insurance class", type: "text", placeholder: "Configured class" }, { key: "currency", label: "Currency", type: "text", placeholder: "ISO currency" }, { key: "investment_linked", label: "Investment linked", type: "text", placeholder: "true or false" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  "plan-tax-configurations": {
  ...
  "plan-target-markets": {
    ...
    columns: commonColumns([{ key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "target_market_type", label: "Market type", field: "target_market_type", sortable: true }, { key: "age", label: "Age range", render: (_value, row) => `${valueLabel(row.min_age)}–${valueLabel(row.max_age)}` }, { key: "occupation_categories", label: "Occupations", field: "occupation_categories", render: (value) => Array.isArray(value) ? value.join(", ") || "All" : valueLabel(value) }, { key: "residency_requirement", label: "Residency", field: "residency_requirement", sortable: true }]), filters: [{ ...scopeFilters[0] }, { ...scopeFilters[1] }, { key: "target_market_type", label: "Market type", type: "text", placeholder: "Configured type" }, { key: "residency_requirement", label: "Residency", type: "text", placeholder: "Configured residency" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  "plan-risk-categories": {
    ...
    columns: commonColumns([{ key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "underwriting_class", label: "Underwriting class", field: "underwriting_class", sortable: true }, { key: "loading_basis", label: "Loading basis", field: "loading_basis", sortable: true }]), filters: [{ ...scopeFilters[0] }, { ...scopeFilters[1] }, { key: "underwriting_class", label: "Underwriting class", type: "text", placeholder: "Configured class" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  "plan-occupation-risk-limits": {
    ...
    columns: commonColumns([{ key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "occupation_risk_category", label: "Occupation risk", field: "occupation_risk_category", sortable: true }, { key: "max_sum_assured", label: "Max sum assured", field: "max_sum_assured", sortable: true, align: "right" }, { key: "loading_rate", label: "Loading", field: "loading_rate", sortable: true, align: "right" }, { key: "exclusion_flag", label: "Excluded", field: "exclusion_flag", render: (value) => <StatusBadge value={value ? "Excluded" : "Allowed"} tone={value ? "danger" : "success"} /> }]), filters: [{ ...scopeFilters[0] }, { ...scopeFilters[1] }, { key: "occupation_risk_category", label: "Occupation risk", type: "text", placeholder: "Configured category" }, { key: "exclusion_flag", label: "Excluded", type: "text", placeholder: "true or false" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  "investment-fund-types": {
  ...
  "investment-funds": {
    ...
    columns: commonColumns([{ key: "fund_type", label: "Fund type", field: "fund_type", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display ?? row.fund_type_display ?? row.plan_type_display) }, { key: "currency", label: "Currency", field: "currency", sortable: true }, { key: "valuation_frequency", label: "Valuation frequency", field: "valuation_frequency", sortable: true }, { key: "unit_price", label: "Unit price", field: "unit_price", sortable: true, align: "right" }]), filters: [{ key: "fund_type", label: "Fund type", type: "text", placeholder: "Search fund types" }, { key: "currency", label: "Currency", type: "text", placeholder: "ISO currency" }, { key: "valuation_frequency", label: "Valuation frequency", type: "text", placeholder: "Configured frequency" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
}

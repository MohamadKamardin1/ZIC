...
const valueLabel = (value: unknown, display?: unknown) => renderFk(value, display)
...
const rateColumns = (label: string): TableColumn<PolicyRecord>[] => commonColumns([
  ...
  { key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) },
  { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) },
...
const screens: Record<ScreenKey, ScreenConfig> = {
  rates: {
    ...
    filters: [
      { key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "frequency", label: "Frequency", type: "text", placeholder: "Configured frequency" }, { key: "currency", label: "Currency", type: "text", placeholder: "ISO currency" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" },
    ],
  },
  grace: {
    ...
    columns: commonColumns([
      { key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "premium_frequency", label: "Premium frequency", field: "premium_frequency", sortable: true }, { key: "grace_days", label: "Grace days", field: "grace_days", sortable: true, align: "right" }, { key: "warning_days", label: "Warning days", field: "warning_days", sortable: true, align: "right" }, { key: "pre_lapse_days", label: "Pre-lapse", field: "pre_lapse_days", sortable: true, align: "right" }, { key: "lapse_days", label: "Lapse days", field: "lapse_days", sortable: true, align: "right" },
    ]),
    filters: [{ key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "premium_frequency", label: "Premium frequency", type: "text", placeholder: "Configured frequency" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  status: {
  ...
  member: {
    key: "member", title: "OL Member Cover Configuration", description: "Effective-dated member and dependent eligibility, waiting period, premium basis, and benefit limits.", endpoint: `${API_PREFIX}/member-cover-configurations/`, columns: commonColumns([{ key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "cover_type", label: "Cover type", field: "cover_type", sortable: true }, { key: "member_relation", label: "Relation", field: "member_relation", sortable: true }, { key: "age_range", label: "Age range", render: (_value, row) => `${valueLabel(row.min_age)} – ${valueLabel(row.max_age)}` }, { key: "waiting_period_days", label: "Waiting days", field: "waiting_period_days", sortable: true, align: "right" }, { key: "benefit_limit", label: "Benefit limit", field: "benefit_limit", sortable: true, align: "right" }]), filters: [{ key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "cover_type", label: "Cover type", type: "text", placeholder: "Configured cover" }, { key: "member_relation", label: "Member relation", type: "text", placeholder: "Configured relation" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  surrender: {
    key: "surrender", title: "OL Surrender Setup", description: "Surrender eligibility, charges, payout timing, partial surrender, and approval behavior.", endpoint: `${API_PREFIX}/surrender-setups/`, columns: commonColumns([{ key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "minimum_policy_months", label: "Min months", field: "minimum_policy_months", sortable: true, align: "right" }, { key: "minimum_premiums_paid", label: "Min premiums", field: "minimum_premiums_paid", sortable: true, align: "right" }, { key: "minimum_premium_paid_ratio", label: "Min ratio", field: "minimum_premium_paid_ratio", sortable: true, align: "right", render: (value) => `${valueLabel(value)}%` }, { key: "surrender_charge_type", label: "Charge type", field: "surrender_charge_type", sortable: true }, { key: "surrender_charge_value", label: "Charge value", field: "surrender_charge_value", sortable: true, align: "right" }, { key: "partial_surrender_allowed", label: "Partial", field: "partial_surrender_allowed", render: (value) => <StatusBadge value={value ? "Allowed" : "Not allowed"} tone={value ? "success" : "neutral"} /> }, { key: "require_approval", label: "Approval", field: "require_approval", render: (value) => <StatusBadge value={value ? "Required" : "Not required"} tone={value ? "warning" : "neutral"} /> }]), filters: [{ key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "surrender_charge_type", label: "Charge type", type: "text", placeholder: "Configured charge type" }, { key: "partial_surrender_allowed", label: "Partial surrender", type: "text", placeholder: "true or false" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  paidup: {
    key: "paidup", title: "OL Paid-Up Setup", description: "Paid-up eligibility thresholds, conversion basis, and effective timing rules.", endpoint: `${API_PREFIX}/paid-up-setups/`, columns: commonColumns([{ key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "minimum_policy_months", label: "Min months", field: "minimum_policy_months", sortable: true, align: "right" }, { key: "minimum_premiums_paid", label: "Min premiums", field: "minimum_premiums_paid", sortable: true, align: "right" }, { key: "paidup_conversion_basis", label: "Conversion basis", field: "paidup_conversion_basis", sortable: true }, { key: "paidup_effective_rule", label: "Effective rule", field: "paidup_effective_rule", sortable: true }, { key: "allow_paidup", label: "Allowed", field: "allow_paidup", render: (value) => <StatusBadge value={value ? "Allowed" : "Disabled"} tone={value ? "success" : "neutral"} /> }]), filters: [{ key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "allow_paidup", label: "Allowed", type: "text", placeholder: "true or false" }, { key: "paidup_conversion_basis", label: "Conversion basis", type: "text", placeholder: "Configured basis" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  surrenderValueRate: {
    key: "surrenderValueRate", title: "OL Surrender Value Rate", description: "Versioned, multi-dimensional surrender value factors with product, gender, smoker, age, term, and policy-year ranges.", endpoint: `${API_PREFIX}/surrender-value-rates/`, columns: rateColumns("Surrender factor"), filters: [{ key: "table_code", label: "Table code", type: "text", placeholder: "Rate table code" }, { key: "rate_table_version", label: "Version", type: "text", placeholder: "Version number" }, { key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "gender", label: "Gender", type: "text", placeholder: "Configured gender" }, { key: "smoker_status", label: "Smoker", type: "text", placeholder: "Configured smoker status" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  paidupRate: {
  ...
  questionnaires: {
    key: "questionnaires", title: "OL Health Questionnaires", description: "Effective-dated, scoped questionnaire versions built from the active health-question catalog.", endpoint: `${API_PREFIX}/health-questionnaires/`, columns: commonColumns([{ key: "version", label: "Version", field: "version", sortable: true }, { key: "applies_to_scope", label: "Scope", field: "applies_to_scope", sortable: true, render: (value) => <StatusBadge value={valueLabel(value)} tone="info" /> }, { key: "product", label: "Product", field: "product", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "plan", label: "Plan", field: "plan", sortable: true, render: (value, row) => valueLabel(value, row.product_display ?? row.plan_display) }, { key: "sum_assured_threshold", label: "Sum threshold", field: "sum_assured_threshold", sortable: true }, { key: "age_threshold", label: "Age threshold", field: "age_threshold", sortable: true }, { key: "version_state", label: "Version state", render: (_value, row) => <StatusBadge value={row.is_active && (!row.effective_to || row.effective_to >= today()) ? "Current" : "Superseded"} tone={row.is_active && (!row.effective_to || row.effective_to >= today()) ? "success" : "neutral"} /> }]), filters: [{ key: "applies_to_scope", label: "Scope", type: "text", placeholder: "GLOBAL, PRODUCT, PLAN, or SCHEME" }, { key: "version", label: "Version", type: "text", placeholder: "Version" }, { key: "product", label: "Product", type: "text", placeholder: "Search products" }, { key: "plan", label: "Plan", type: "text", placeholder: "Plan display (read-only)" }, { key: "is_active", label: "Active status", type: "text", placeholder: "true or false" }],
  },
  questionnaireBuilder: {
...
function RateEditor({ value, onChange, rateRows, setRateRows, error, versioned }: { value: EditorState; onChange: (key: string, next: string | number | boolean | null) => void; rateRows: RateEditorRow[]; setRateRows: (rows: RateEditorRow[]) => void; error: (key: string) => string | undefined; versioned: boolean }) {
  ...
  const text = (key: string, label: string, required = false) => <EditorField label={label} name={key} value={value[key]} required={required} error={error(key)} onChange={(event) => onChange(key, event.target.value)} />
  const fkField = (key: "product" | "plan", label: string, required = false) => key === "product" ? <SmartSelect entity="products" label={label} name={key} required={required} value={String(value[key] ?? "")} error={error(key)} onChange={(next) => onChange(key, next)} placeholder="Search and select product" /> : <TextInput label={label} name={key} value={renderFk(value[key], value[`${key}_display`])} readOnly />
  return <div className="space-y-4">
    <CommonEditorFields value={value} onChange={onChange} error={error} />
    <div className="grid gap-4 sm:grid-cols-2">{versioned ? <>{text("table_code", "Table code", false)}{text("rate_table_version", "Rate table version", false)}{fkField("product", "Product", true)}{fkField("plan", "Plan")}{text("gender", "Gender")}{text("smoker_status", "Smoker status")}</> : <>{fkField("product", "Product", true)}{fkField("plan", "Plan")}{text("installment_type", "Installment type", true)}{text("frequency", "Frequency", true)}{text("currency", "Currency")}</>}</div>
...
function PolicyEditor({ screen, value, onChange, rateRows, setRateRows, allowedTransitions, setAllowedTransitions, transitionOptions, error }: { screen: ScreenKey; value: EditorState; onChange: (key: string, next: string | number | boolean | null) => void; rateRows: RateEditorRow[]; setRateRows: (rows: RateEditorRow[]) => void; allowedTransitions: string[]; setAllowedTransitions: (values: string[]) => void; transitionOptions: PolicyRecord[]; error: (key: string) => string | undefined }) {
  ...
  if (screen === "grace") return <div className="space-y-4"><CommonEditorFields value={value} onChange={onChange} error={error} /><div className="grid gap-4 sm:grid-cols-2">{fkField("product", "Product")}{fkField("plan", "Plan")}{text("premium_frequency", "Premium frequency")}{numeric("grace_days", "Grace days")}{numeric("warning_days", "Warning days")}{numeric("pre_lapse_days", "Pre-lapse days")}{numeric("lapse_days", "Lapse days")}{numeric("minimum_due_amount", "Minimum due amount", true)}</div><InfoBanner title="Timing validation">Grace, warning, and pre-lapse days cannot exceed the configured lapse days.</InfoBanner></div>
  ...
  if (screen === "member") return <div className="space-y-4"><CommonEditorFields value={value} onChange={onChange} error={error} /><div className="grid gap-4 sm:grid-cols-2">{fkField("product", "Product")}{fkField("plan", "Plan")}{text("cover_type", "Cover type", true)}{text("member_relation", "Member relation", true)}{numeric("min_age", "Minimum age")}{numeric("max_age", "Maximum age")}{numeric("waiting_period_days", "Waiting period days")}{numeric("benefit_limit", "Benefit limit", true)}{text("premium_basis", "Premium basis")}{text("coverage_basis", "Coverage basis")}</div><InfoBanner title="Eligibility validation">Maximum age cannot be less than minimum age, and benefit limits cannot be negative.</InfoBanner></div>
  ...
  if (screen === "reinstatement") return <div className="space-y-4"><CommonEditorFields value={value} onChange={onChange} error={error} /><div className="grid gap-4 sm:grid-cols-2">{fkField("product", "Product")}{fkField("plan", "Plan")}{numeric("days_after_lapse", "Days after lapse", false)}{numeric("maximum_reinstatements", "Maximum reinstatements")}{numeric("interest_rate", "Interest rate (%)", true)}{numeric("penalty_rate", "Penalty rate (%)", true)}</div><div className="grid gap-4 sm:grid-cols-2"><Toggle label="Require medical underwriting" checked={Boolean(value.require_medical_underwriting)} onChange={(checked) => onChange("require_medical_underwriting", checked)} /><Toggle label="Require outstanding premium payment" checked={Boolean(value.require_outstanding_premium_payment)} onChange={(checked) => onChange("require_outstanding_premium_payment", checked)} /></div><InfoBanner title="Reinstatement validation">Days after lapse must be positive. Interest and penalty rates must remain between 0 and 100 percent.</InfoBanner></div>
  if (screen === "surrender") return <div className="space-y-4"><CommonEditorFields value={value} onChange={onChange} error={error} /><div className="grid gap-4 sm:grid-cols-2">{fkField("product", "Product")}{fkField("plan", "Plan")}{numeric("minimum_premiums_paid", "Minimum premiums paid")}{numeric("minimum_policy_months", "Minimum policy months")}{numeric("minimum_premium_paid_ratio", "Minimum premium ratio (%)", true)}{text("surrender_charge_type", "Surrender charge type")}{numeric("surrender_charge_value", "Surrender charge value", true)}{numeric("surrender_payout_days", "Surrender payout days")}</div><div className="grid gap-4 sm:grid-cols-2"><Toggle label="Partial surrender allowed" checked={Boolean(value.partial_surrender_allowed)} onChange={(checked) => onChange("partial_surrender_allowed", checked)} /><Toggle label="Require approval" checked={Boolean(value.require_approval)} onChange={(checked) => onChange("require_approval", checked)} /></div><InfoBanner title="Overlap warning">Active surrender setups with the same product and plan scope cannot overlap effective dates.</InfoBanner></div>
  if (screen === "paidup") return <div className="space-y-4"><CommonEditorFields value={value} onChange={onChange} error={error} /><div className="grid gap-4 sm:grid-cols-2">{fkField("product", "Product")}{fkField("plan", "Plan")}{numeric("minimum_premiums_paid", "Minimum premiums paid")}{numeric("minimum_policy_months", "Minimum policy months")}{text("paidup_conversion_basis", "Paid-up conversion basis")}{text("paidup_effective_rule", "Paid-up effective rule")}</div><Toggle label="Paid-up conversion allowed" checked={Boolean(value.allow_paidup)} onChange={(checked) => onChange("allow_paidup", checked)} /><InfoBanner title="Eligibility validation">When paid-up conversion is allowed, at least one premium or policy-month threshold is required.</InfoBanner></div>

              ...
              {drawerMode === "primary" ? (
                ...
                <div className="flex min-h-0 flex-1 flex-col">
                  <div className="flex-1 space-y-5 overflow-y-auto px-6 py-6">
                    ...
                    {view === "proposals" && typeof selected?.id === "string" ? <DocumentInstancesPanel sourceType="ol_proposals.olproposal" objectId={selected.id} documentType="PROPOSAL_SUMMARY" title="Proposal documents" renderLabel="Generate proposal PDF" /> : null}

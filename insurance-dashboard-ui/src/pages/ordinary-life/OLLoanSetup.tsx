...
const filters: Record<ScreenKey, Array<{ key: string; label: string; type: "text" | "select"; placeholder?: string }>> = {
  system: [{ key: "product", label: "Product", type: "select" }, { key: "plan", label: "Plan", type: "select" }, { key: "loan_basis", label: "Loan basis", type: "select" }, { key: "is_active", label: "Status", type: "select" }],
  interest: [{ key: "product", label: "Product", type: "select" }, { key: "plan", label: "Plan", type: "select" }, { key: "compounding_frequency", label: "Compounding", type: "select" }, { key: "interest_calculation_basis", label: "Calculation basis", type: "select" }, { key: "is_active", label: "Status", type: "select" }],
}
...
export default function OLLoanSetup() {
  ...
  const choiceFields = screen === "system" ? ["product", "plan", "loan_basis", "effect_on_claim", "effect_on_surrender", "effect_on_maturity"] : ["product", "plan", "compounding_frequency", "interest_calculation_basis"]

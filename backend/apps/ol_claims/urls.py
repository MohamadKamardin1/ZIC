...
from .document_views import ClaimAssessmentReadinessView, ClaimDischargeVoucherPrintView, ClaimDocumentsView
...
from .settlement_views import ClaimSettlementView
from .options import (
...
urlpatterns = [
    ...
    path("claims/<uuid:claim_id>/settle/", ClaimSettlementView.as_view(), name="claim-settle"),
    path("claims/<uuid:claim_id>/print-discharge-voucher/", ClaimDischargeVoucherPrintView.as_view(), name="claim-discharge-voucher-print"),

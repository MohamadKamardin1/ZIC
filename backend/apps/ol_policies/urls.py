...
from .document_views import PolicyContractPrintView, PolicySchedulePrintView, WithdrawalStatementPrintView
...
from .staff_withdrawal_views import (
    StaffWithdrawalActionView,
    StaffWithdrawalAuditView,
    StaffWithdrawalBreakdownView,
    StaffWithdrawalDetailView,
    StaffWithdrawalEligibilityView,
    StaffWithdrawalEstimateView,
    StaffWithdrawalKpiView,
    StaffWithdrawalListView,
    StaffWithdrawalOptionsView,
    StaffWithdrawalPaymentsView,
    StaffWithdrawalRequestView,
)
...
urlpatterns = [
    ...
    path("policies/<uuid:policy_id>/withdrawals/eligibility/", StaffWithdrawalEligibilityView.as_view(), name="policy-withdrawal-eligibility"),
    path("policies/<uuid:policy_id>/withdrawals/", PolicyWithdrawalListCreateView.as_view(), name="policy-withdrawals"),
    path("withdrawals/estimate/", StaffWithdrawalEstimateView.as_view(), name="withdrawal-estimate"),
    path("withdrawals/options/<str:kind>/", StaffWithdrawalOptionsView.as_view(), name="withdrawal-options"),
    path("withdrawals/<uuid:withdrawal_id>/breakdown/", StaffWithdrawalBreakdownView.as_view(), name="withdrawal-breakdown"),
    path("withdrawals/<uuid:withdrawal_id>/payments/", StaffWithdrawalPaymentsView.as_view(), name="withdrawal-payments"),
    path("withdrawals/<uuid:withdrawal_id>/audit/", StaffWithdrawalAuditView.as_view(), name="withdrawal-audit"),
    path("withdrawals/<uuid:withdrawal_id>/print-statement/", WithdrawalStatementPrintView.as_view(), name="withdrawal-print-statement"),
    path("withdrawals/<uuid:withdrawal_id>/<str:action>/", StaffWithdrawalActionView.as_view(), name="withdrawal-action"),
    path("withdrawals/<uuid:withdrawal_id>/", StaffWithdrawalDetailView.as_view(), name="withdrawal-detail"),
    path("withdrawals/", StaffWithdrawalListView.as_view(), name="withdrawal-list"),
    path("withdrawals/kpis/", StaffWithdrawalKpiView.as_view(), name="withdrawal-kpis"),
    path("policies/<uuid:policy_id>/withdrawals/request/", StaffWithdrawalRequestView.as_view(), name="policy-withdrawal-request"),
